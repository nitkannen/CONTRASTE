...
if __name__ == '__main__':
  ...
  parser.add_argument(
        "--avg_window",type=int, default=10, help="The length of the running window to print loss.",
    )
  ...
  for epoch in range(1, epochs + 1):
    ...
    pbar.set_description(f"Epoch: {epoch}, Running loss: {np.mean(list(window_stats)):.2f}")
    ...
    if(epoch == 1 or epoch == 2 or epoch == 6 or epoch == 8 or epoch == 10 or epoch == 12 or epoch == 14): ## needs editing
